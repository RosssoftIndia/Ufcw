<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Notes.aspx.cs" Inherits="Common_Shops_Notes" %>
                        ...
                        <telerik:GridTemplateColumn HeaderText="RecordID" Visible="false">
                           ...
                           <telerik:GridTemplateColumn HeaderText="Flag">
                            ...
                            <telerik:GridBoundColumn DataField="CreateDate" DataType="System.DateTime" 
                                FilterControlAltText="Filter CreateDate column" HeaderText="CreateDate" 
                                SortExpression="CreateDate" UniqueName="CreateDate">
                            </telerik:GridBoundColumn>
                             <%--<telerik:GridTemplateColumn HeaderText="Action">
                            <ItemTemplate>
                            <asp:LinkButton ID="btndelete"  runat="server" class="del-icon" CommandName="Delete"> </asp:LinkButton>
                            </ItemTemplate>
                            </telerik:GridTemplateColumn>--%>
                            
                            <telerik:GridButtonColumn UniqueName="DeleteCol" Text="Delete"  ButtonType="ImageButton" ButtonCssClass="del-icon" ImageUrl="~/img/glyphicons-halflings.png" CommandName="Delete" >
