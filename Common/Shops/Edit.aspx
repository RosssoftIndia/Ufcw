<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit.aspx.cs" MasterPageFile="~/Common/Common.master"   Inherits="Common_Shops_Edit" %>
...
<asp:ScriptReference Assembly="Telerik.Web.UI" Name="Telerik.Web.UI.Common.jQueryInclude.js"></asp:ScriptReference>
 ...
 <div class="bodycontainer">
  ...
  <tr>
   <td class="pgHeading" >Edit Shop</td>
  <td>
 <div class="buttons">   
 ...
 <div class="tabwrapper" >
        ...
        <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="multiPage">
            <telerik:RadPageView ID="RadPageView1" runat="server">   
             <table id="block" runat="server" class="outter full">  
            <tr>
            ...
            <td>        
              <table class="section">	               
		    <tr><td style="width:100px">Shop-ID</td><td><telerik:RadNumericTextBox ID="ShopID"  MinValue="0" Width="160px" height="25px" runat="server" Type="Number" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="" Enabled="false">
            ...
            <tr><td>City<span style="color:#FF0000">*</span></td><td><asp:TextBox ID="Pri_City" runat="server" CssClass="uptext" ></asp:TextBox>
...
<DateInput DisplayDateFormat="M/d/yyyy" DateFormat="M/d/yyyy" LabelWidth="40%"></DateInput>
                 ...
                 <div class="btn_bar">
                <div height="30">                        
                    <asp:Button ID="btn_Submit" CssClass="btnsubmit" runat="server" Text="Update" 
                        ValidationGroup="Tab1" CausesValidation="true"  
                        onclick="btn_tab1_Click"/>
                   </div>
               </div>                 
            </telerik:RadPageView>
...
<EditColumn UniqueName="EditCommandColumn1" FilterControlAltText="Filter EditCommandColumn1 column"></EditColumn>
         ...
         <div class="btn_bar">                                       
                    <asp:Button ID="btn_tab2" CssClass="btnsubmit" runat="server"   Text="Next" 
                        onclick="btn_tab2_Click" Visible="False" />                 
               </div>      
            </telerik:RadPageView>   
      ...
      <div class="btn_bar">                                       
            ...
            <telerik:RadPageView ID="RadPageView5" runat="server" CssClass="pageViewEducation"> 
                  ...
                  <telerik:RadGrid ID="Doc_Grid" runat="server" AllowSorting="false" 
                          ...
                          onneeddatasource="Doc_Grid_NeedDataSource" 
                          OnItemDataBound="Doc_Grid_ItemDataBound" onitemcommand="Doc_Grid_ItemCommand">
                  <MasterTableView>
                  <Columns>
                 ...
                 <asp:Label ID="FileExt" runat="server" Text='<%#Eval("Extension")%>'></asp:Label>
                  ...
                  <ItemTemplate>
                  <asp:ImageButton ID="Img_Update" runat="server" ImageUrl="~/images/delete.png" OnClientClick="return confirm('Are you sure you want to delete this Document?');"  CommandName="Delete"  CommandArgument='<%# DataBinder.Eval(Container.DataItem,"RecordID")%>' />
                  </ItemTemplate>
                  </telerik:GridTemplateColumn>
                  </Columns>
                  </MasterTableView>             
