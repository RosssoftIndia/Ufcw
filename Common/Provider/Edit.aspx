<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Common_Provider_Edit" MasterPageFile="~/Common/Common.master"%>
...
<div class="bodycontainer">
 <table class="submenu_wrapper" >
  <tr>
   <td class="pgHeading" >Edit Provider</td>
  <td>
 <div class="buttons">   
    ...
    <tr>
        <td>
            <table class="section" border="0" cellpadding="4" cellspacing="3" width="100%">
               <%-- <tr height="40px">
                    <td colspan="2" class="Heading">Update Provider</td>
                </tr>--%>
                <tr>
