<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportAflacCensus.aspx.cs" Inherits="ReportAflacCensus" MasterPageFile="~/Common/Common.master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder"  ID="Contentblk" runat="server">
  ...
  <tr>
   <td class="pgHeading" >Report - Aflac Census</td>
   ...
   <table class="full" style="margin-bottom:20px;margin-right :60px;">
        ...
        onselectedindexchanged="Drp_shop_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox></td>
            ...
            <tr><td><telerik:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="1200px" Skin="Orange" SkinsPath="Skins"></telerik:ReportViewer>
