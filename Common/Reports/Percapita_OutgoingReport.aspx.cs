...
public partial class Common_Reports_Percapita_OutgoingReport : SessionTracker 
{
    ...
    protected void Percapitabtn_Click(object sender, EventArgs e)
    {
        ...
        mySqlCommand.CommandText = "Percapita_outgoing_sp";
        ...
        string path = Server.MapPath("~/App_Data/TempExport/Percapita_Outgoing.txt");
    ...
    public void DataTable2CSV(DataSet Dataset, string filename, string sepChar)
    {
        ...
        string Header = "0312   "+Headdate+"OUTGOINGFILE        ";
        string Footer = "0312   "+Headdate+"OUTGOINGFILE        " + Count_table;
