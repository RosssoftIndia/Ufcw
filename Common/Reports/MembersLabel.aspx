<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MembersLabel.aspx.cs" Inherits="Common_Reports_MembersLabel" MasterPageFile="~/Common/Common.master"%>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder"  ID="Contentblk" runat="server">
  ...
  <tr>
   <td class="pgHeading" >Report - MembersLabel</td>
   ...
   <table class="full" style="margin-bottom:20px;margin-right :60px;">
           <tr><td>Shop</td><td>Style</td></tr>
           <tr>
           <td><telerik:RadScriptManager ID="script" runat="server"></telerik:RadScriptManager>
            <telerik:RadComboBox ID="Drp_shop" Width="220px" runat="server" ></telerik:RadComboBox>    </td>
            <td>
            <telerik:RadComboBox ID="Drp_Style" Width="220px" runat="server" >
            <Items>
            <telerik:RadComboBoxItem Text="4*2 Label" Value="1" />
            <telerik:RadComboBoxItem Text="4*1 Label" Value="2" />
            </Items>
            </telerik:RadComboBox>
