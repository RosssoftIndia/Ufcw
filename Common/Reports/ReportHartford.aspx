<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportHartford.aspx.cs" Inherits="ReportHartford" MasterPageFile="~/Common/Common.master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder"  ID="Contentblk" runat="server">
  ...
  <tr>
   <td class="pgHeading" >Report - Hartford</td>
