<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopLable.aspx.cs" Inherits="Common_Reports_ShopLable" MasterPageFile="~/Common/Common.master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder"  ID="Contentblk" runat="server">
  ...
  <tr>
   <td class="pgHeading" >Report - ShopLabel</td>
