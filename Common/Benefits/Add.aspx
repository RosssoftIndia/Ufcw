<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add.aspx.cs" MasterPageFile="~/Common/Common.master"   Inherits="Common_Benefits_Add" %>
...
<div class="bodycontainer">
 <table class="submenu_wrapper" >
  <tr>
  <td class="pgHeading" >Add Benefits</td>
  <td>
    <div class="buttons">      
    ...
    <tr>
        <td>
            <table class="section" border="0" cellpadding="4" cellspacing="3" width="100%">
               <%-- <tr height="40px">
                    <td colspan="2" class="Heading">Create Benefits</td>
                </tr>--%>
                <tr>
