<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add.aspx.cs" MasterPageFile="~/Admin/Admin.master"   Inherits="Admin_Delegate_Add" %>
    ...
    <tr>
        <td>
            <table class="section" border="0" cellpadding="4" cellspacing="3" width="100%">
                <tr height="40px">
                    <td colspan="2" class="Heading">Create Delegate</td>
                </tr>
                <tr>
